###### The following codes are used to generate Figure 2 in Wang et al. "Towards a unified understanding: the linkage of MaxEnt, ETRHEQ, and SFE Models in estimating evapotranspiration"
...
ggsave("Figure 2 .png", plot=model_simulation, dpi =800, width =10 , height = 10)
